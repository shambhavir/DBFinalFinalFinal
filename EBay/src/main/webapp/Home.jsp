...
<body style="text-align: center">
	...
	while (result.next()) {
	listOfClosedAuctions.add(new Winner(result.getString("username"), result.getInt("AID"),
			result.getFloat("itemReserveAmount"), result.getFloat("itemCurrentPrice")));
	}
	...
	String findItem = "SELECT * FROM Events WHERE itemEndDateTime <= \"" + currentDayTime + "\" AND status = \"Open\"";
